        ...
        while Maroon.health>0:
            ...
            if moveset== "1":
                ...
                if n == 1:
                    ...
                    Zombiee.health=Zombiee.health-(dmg*2)
                    print("Your health is..",Maroon.health)
                    v
                    print("The zombie's health is",Zombiee.health)
                elif n == 2:
                ...
                if random.choice(op2) == ("Nice!The zombie's hp dropped by 15!"):
                    Zombiee.health=Zombiee.health-dmg
                    v
                    print("The zombie's health is",Zombiee.health)
                    v
                ...
                if random.choice(op3) == ("You used your damage potion! The zombie's hp dropp…"):
                    ...
                    Zombiee.health=Zombiee.health-pdmg
                    time.sleep(1.5)
                    print("The zombie's health is",Zombiee.health)
                    time.sleep(1.5)
